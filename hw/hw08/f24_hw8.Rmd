...
We find that $p > .05$, so we accept the null hypothesis that the mean of the observed data is the mean of the Poisson which implies the data is sampled from a Poisson.
