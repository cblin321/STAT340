...
reps = replicate(1e4, unname(tableOfPairs(rbinom(length(split(flips1)), 1, .5))[ "10"]))
...
```{r}
#seems to have long sequences of H or T, sim from Binom(N, .5) using the running ratio as a test statistic
